...
from desynced_wiki_scripts.models.decorators import DesyncedObject
from desynced_wiki_scripts.models.decorators_options import (
...
class DataClassTypeInfo(TypeInfo):
    ...
    dataclass_options: DataClassFieldOptions = field(default_factory=DataClassFieldOptions)
...
def analyze_type(obj_type: Type) -> TypeInfo | DataClassTypeInfo:
    ...
    for field_info in fields(obj_type):
        ...
        if hasattr(field_type, "__origin__") and field_type.__origin__ is list:
            ...
            assert list_field.list_options.max_length, f"{field_info.name} in {obj_type} is missing max_length"
