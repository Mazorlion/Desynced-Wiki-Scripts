...
FETCHED_GAME_DATA_DIR = "game_data"
...
WIKI_NAME_OVERRIDES: dict[str, str] = {
    ...
    "c_ravager_virus_converter": "Trilobyte Virus Converter",
    "c_explorable_scannable": "Explorable Scannable",
    "c_alien_scout_terraformer": "Alien Integrated Terraformer (Scout)",
    "t_human_tech_basic": "Human Technology (Basic)",
    "t_alien_tech_basic": "Alien Technology (Basic)",
    "t_human_faction_npc": "Human Technology (NPC)",
    "t_alien_faction_npc": "Alien Technology (NPC)",
