...
from .decorators_options import require_field_options
...
def length_check(cls) -> Type:
    ...
    """
    orig_post_init = cls.__post_init__ if hasattr(cls, "__post_init__") else lambda self: None
    ...
    def new_post_init(self):
        ...
        for field_name, field_info in self.__dataclass_fields__.items():
            ...
            if max_length and len(value) > max_length:
                raise ValueError(f"The list length for '{field_name}' must not exceed {max_length}.")
